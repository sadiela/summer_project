...
ghrelin_shortlist <- cbind(ghrelin_shortlist, islet_phenos)
ghrelin_phenos <- cbind(ghrelin_phenos, islet_phenos)
...
ghrelin_shortlist <- cbind(ghrelin_shortlist, weight_change_ave)
ghrelin_phenos <- cbind(ghrelin_phenos, weight_change_ave)

islet_phenos <- cbind(islet_phenos, change_ave)

write.csv(ghrelin_phenos, file = "data/ghrelin_phenos.csv")
write.csv(ghrelin_shortlist, file = "data/ghrelin_shortlist.csv")
